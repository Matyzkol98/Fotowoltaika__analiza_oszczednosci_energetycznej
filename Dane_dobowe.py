...
#plik_fotowoltaika_dobowe()

# --------- funkcja pobieranie pliku z Tauron ---------
#plik_tauron_dobowe()

# --------- przekształcenia plików wsadowych z pobraniem plików z Falownika i Tauron ---------
nowy_plik_fv = plik_fotowoltaika_dobowe()[['Zaktualizowany czas', 'Dzień tygodnia', 'Produkcja(kWh)']]
nowy_plik_tauron = plik_tauron_dobowe()[['Zaktualizowany czas', 'Pobór energii [kWh]', 'Oddanie [kWh]']]
...
db_dobowe()                                                                    # wywołanie funkcji do tworzenia pliku DB
